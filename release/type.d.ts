...
export type Call<A extends boolean = false, B extends boolean = false> = B extends true ? A extends true ? BeforeAfterCall : BeforeCall : A extends true ? AfterCall : Callback;
